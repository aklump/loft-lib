...
! ./vendor/bin/phpswap use 7.3 $verbose './vendor/bin/phpunit -c tests_phpunit/src/phpunit.xml' && failed "     PHP 7.3 tests failed.     " && exit 1
! ./vendor/bin/phpswap use 7.4 $verbose './vendor/bin/phpunit -c tests_phpunit/src/phpunit.xml' && failed "     PHP 7.4 tests failed.     " && exit 1
