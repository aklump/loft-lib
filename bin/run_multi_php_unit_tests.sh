...
! ./vendor/bin/phpswap use 8.1 $verbose './vendor/bin/phpunit -c tests_unit/phpunit.v10.xml' && failed "     PHP 8.1 tests failed.     " && exit 1
! ./vendor/bin/phpswap use 8.2 $verbose './vendor/bin/phpunit -c tests_unit/phpunit.v10.xml' && failed "     PHP 8.2 tests failed.     " && exit 1
